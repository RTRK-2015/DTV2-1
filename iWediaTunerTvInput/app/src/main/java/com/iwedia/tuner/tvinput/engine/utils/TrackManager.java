...
public abstract class TrackManager<T> {
    ...
    private int mType = -1;
    private T mSelectedTrack = null;
    private HashMap<String, T> mTracks = null;
     ...
     */
    public abstract int getTrackCount(int routeId) throws RemoteException;
    /**
     ...
     * @return Track
     */
    public abstract T getTrack(int routeId, int index) throws RemoteException;
