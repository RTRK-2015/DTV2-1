...
import com.iwedia.tuner.tvinput.engine.epg.EpgFull.IEpgAcquisitionListener;
...
public class EpgAcquisitionManager implements IEpgAcquisitionListener {
    ...
    public boolean shouldStartEPGAquistion() throws RemoteException {
        long key = DtvEngine.getInstance().getCurrentTransponder();
